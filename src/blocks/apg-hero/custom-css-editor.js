...
export default function CustomCSSEditor( { value, onChange, label } ) {
    ...
    return (
        <div className="apg-hero-custom-css-editor">
            { label && (
                <label
                    style={ {
                        display: 'block',
            ...
            >
                ...
                Usa el selector <code style={ { background: '#f0f0f0', padding: '2px 4px', borderRadius: '2px' } }>.apg-hero</code> para estilizar el bloque.
            </p>
        </div>
    );
}
